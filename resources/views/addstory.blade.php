...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
		<div class="container">
    		...
    		<form action="../api/addstory" method="POST">
				@csrf
    		    ...
    		    <div class="form-group">
    		        ...
    		        <div><textarea rows="5" class="form-control" name="content" style="width: 100%"></textarea></div>
    		    </div>
    		    ...
    		    <div class="form-group">
    		        ...
    		        <button type="button" onclick="window.location.href='../profile'" class="btn btn-default">
    		            Cancel
    		        </button>
    		    </div>
